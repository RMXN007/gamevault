...
-   `GameVault/frontend/src/components/layout`: Common layout elements like Navbar and Footer.
-   `GameVault/frontend/src/components/ui`: Reusable UI elements (GameCard, Buttons, GameRow).
-   `GameVault/frontend/src/contexts`: Theme management and global state.
-   `GameVault/frontend/src/data`: Mock data for games and users.
-   `GameVault/frontend/src/pages`: Main page views (Home, Library, Profile, etc.).
-   `GameVault/frontend/src/index.css`: Implementation of the 4 design systems via CSS variables.
